...
public class TurmaController {
	...
	@GetMapping("/{id}")
	@Operation(summary = "Listar turma escolhida pelo ID")
	...
	@GetMapping("/dto/{id}")
	@Operation(summary = "Listar turmaDTO escolhida pelo id")
	...
	@PostMapping("/dto")
	@Operation(summary = "Adicionar nova turmaDTO")
	...
	@PostMapping
	@Operation(summary = "Adicionar nova turma")
	...
	@PutMapping
	@Operation(summary = "Editar turma existente")
